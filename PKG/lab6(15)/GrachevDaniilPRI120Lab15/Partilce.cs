    ...
    class Explosion
    {
        ...
        public void Boooom(float time_start)
        {
            ...
            for (int ax = 0; ax < _particles_now; ax++)
            {
                ...
                PartilceArray[ax].SetPower(_power_rnd * ((float)rnd.Next(100, 1000) / 1000.0f) * 2, _power_rnd * ((float)rnd.Next(100, 1000) / 1000.0f) * 10, _power_rnd * ((float)rnd.Next(100, 1000) / 1000.0f) * 10);
            }
