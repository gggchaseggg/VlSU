...
namespace port_form
{
    public partial class Form1 : Form
    {
        ...
        private void SaveSudnoInfo_Button_Click(object sender, EventArgs e)
        {
            ...
            var korablik = new Passenger(NameTB, VmestimostTB, VesTB, PassengerAmountTB);

            korablik.sessionevent += DisplayMessage;

            if (VmestimostTB == PassengerAmountTB)
            {
                korablik.SudnoNotify();
            }
