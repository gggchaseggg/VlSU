...
namespace Port
{
    ...
    interface korabl
    {
        void Zagruzhen();
        void PrintInfo();
        void PlusPassenger(int plus_size);
    }
    ...
    abstract class Sudno
    {
        ...
        protected Sudno(string name, int vmest, int ves)
        {
            ...
            this.Vmest = vmest;
            this.Ves = ves;
            Console.WriteLine($"Вызван Конструктор Класса для {name}");
    ...
    class Passenger : Sudno,korabl
    {
        ...
        public void Zagruzhen()
        {
            Console.WriteLine("Вызван метод Zagruzhen");
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss"));
            if (PasAmount == Vmest)
            {
        ...
        {
            Console.WriteLine("--------------------------------------------------");
            Console.WriteLine("Вызван метод PrintInfo");
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss"));
        ...
        {
            Console.WriteLine("Вызван метод PlusPassenger");
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss"));
