...
videoFps = 75
videoCodec = "avc1"
videoFilename = "2 semestr/practice/Zadanie1/output.mp4"
videoLength = 3
...
def graph_from_file():
    file = open("2 semestr/practice/Zadanie1/data.txt", "r")
...
for i in range(len(z)):
    ...
    frameDrawer = ImageDraw.Draw(frame)
    video.write(cv2.cvtColor(np.array(frame), cv2.COLOR_RGB2BGR))
img.save("2 semestr/practice/Zadanie1/draw_dfs.png", "PNG")
img.show()
video.release()